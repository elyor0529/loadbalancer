...
namespace Kvpbase
{
    public class Setup
    {
        ...
        { 
            ...
            Console.WriteLine("");
            Console.WriteLine("Kvpbase LoadBalancer");
            Console.WriteLine("");
                            //          1         2         3         4         5         6         7
        ...
        private List<Host> InputHosts()
        {
            ...
            //                 12345678901234567890123456789012345678901234567890123456789012345678901234567890
            Console.WriteLine("");
            Console.WriteLine("The loadbalancer distributes traffic destined to a given 'host' to a 'node'");
        ...
        private List<Node> InputNodes(string name)
        {
            ...
            //                 12345678901234567890123456789012345678901234567890123456789012345678901234567890
            Console.WriteLine("");
            Console.WriteLine("Enter at lest one node to which requests for " + name + " should be routed.");
